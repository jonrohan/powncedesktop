...
BIN
 ...
 - adl.exe - The AIR Debug Launcher (ADL) allows you to test an AIR application without having to package and install it. 
 - adt.bat - The AIR Developer Tool (ADT) packages your application as a .air file for distribution.  
...
LIB
 ...
 - Descriptor.1.0.xsd - The application descriptor schema file. 
