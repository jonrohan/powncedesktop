            ...
            if (content) {
                ...
                if (props.settings) {
					...
					if(!props.settings.toolbar_icon_text)
						properties.settings.toolbar_icon_text = false;
