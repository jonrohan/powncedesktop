...
PownceDesktop.prototype = {
	...
	getDisplaySince: function(seconds_since) {
		var result = "";
	...
	prepareNoteFromDB: function(note) {
		...
		note.seconds_since = this.getSecondsSince(note.timestamp);
		note.display_since = this.getDisplaySince(note.seconds_since);
