...
PownceDesktop.DisplaySinceCronJob = function() {
	...
	this.update = function() {
        for (i = 0; i < properties.json.notes.length; i++) {
			...
			$$("#note_" + note.id + " .note-time")[0].innerHTML = note.display_since;
        }
	};
	this.stop = function() {
