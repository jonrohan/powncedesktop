...
PownceDesktop.prototype = {
    ...
    doSaveProperties: function(){
		try {
	        ...
	        var props = "{version:" + VERSION + ",settings:{x:" + properties.settings.x + ",y:" + properties.settings.y + ",width:" + properties.settings.width + ",height:" + properties.settings.height + ",play_sound:" + properties.settings.play_sound + ",sound:" + properties.settings.sound + ",max_notes:" + properties.settings.max_notes + ", minimize_to_tray: " + properties.settings.minimize_to_tray + ",auto_login:" + properties.settings.auto_login + "}}";
	...
	addSettingsEvents: function() {
		$('settings-play-sound').addEventListener('click', function() { 
			...
			if (properties.settings.play_sound) {
				$('sounds').className = "sounds-enabled";
			}
			else {
				$('sounds').className = "sounds-disabled";
			}
